...
action="https://pagseguro.uol.com.br/v2/checkout/payment.html">  
        ...
        <input name="shippingAddressNumber" type="hidden">  
        ...
        <input name="shippingAddressState" type="hidden">  
        <input name="shippingAddressCountry" type="hidden">  
...
<script src="text/javascript">
        ...
        document.getElementById('shippingAddressStreet').value = '<?php echo utf8_encode($order["desaddress"]); ?>';
        document.getElementById('shippingAddressNumber').value = '<?php echo utf8_encode($order["desnumber"]); ?>';
        document.getElementById('shippingAddressComplement').value = '<?php echo utf8_encode($order["descomplement"]); ?>';
        document.getElementById('shippingAddressCity').value = '<?php echo utf8_encode($order["descity"]); ?>';
        document.getElementById('shippingAddressState').value = '<?php echo utf8_encode($order["desstate"]); ?>';
        document.getElementById('shippingAddressCountry').value = '<?php echo utf8_encode($order["descountry"]); ?>';
        document.getElementById('senderName').value = '<?php echo utf8_encode($order["desperson"]); ?>';
</script>